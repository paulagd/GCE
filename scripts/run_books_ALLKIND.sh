...
# python main.py --dataset $1 --algo_name ncf --rankall --gce --epochs $2 --lr 0.01 --batch_size 2048 --dropout 0 --not_early_stopping > results/context/outputs_$1/UIC_graph_$1_NCF_epochs=$2.txt
