...
#python main.py --dataset $1 --algo_name mf --rankall --epochs $2 --lr 0.0005 --batch_size 256 --dropout 0.15 --not_early_stopping > results/context/outputs_$1/UIC_reindexed_$1_mf_epochs=$2.txt
#echo "DONE MF REINDEXED-UIC" #done
#python main.py --dataset $1 --algo_name deepfm --rankall --epochs $2 --lr 0.01 --batch_size 512 --dropout 0.15 --not_early_stopping > results/context/outputs_$1/UIC_reindexed_$1_dfm_epochs=$2.txt
#echo "DONE DEEPMF REINDEXED-UIC" #dones
#python main.py --dataset $1 --algo_name fm --rankall --epochs $2 --lr 0.0005 --batch_size 2048 --dropout 0.15 --not_early_stopping > results/context/outputs_$1/UIC_reindexed_$1_fm_epochs=$2.txt
...
#python main.py --dataset $1 --algo_name mf --rankall --gce --epochs $2 --lr 0.005 --batch_size 2048 --dropout 0.5 --not_early_stopping > results/context/outputs_$1/UIC_graph_$1_mf_epochs=$2.txt
#echo "DONE MF GCE-UIC"
#python main.py --dataset $1 --algo_name deepfm --rankall --gce --epochs $2 --lr 0.01 --batch_size 256 --dropout 0.5 --not_early_stopping > results/context/outputs_$1/UIC_graph_$1_deepfm_epochs=$2.txt
#echo "DONE deepfm GCE-UIC"  # done
#python main.py --dataset $1 --algo_name fm --rankall --gce --epochs $2 --lr 0.01 --batch_size 2048 --dropout 0 --not_early_stopping > results/context/outputs_$1/UIC_graph_$1_fm_epochs=$2.txt
#echo "DONE FM GCE-UIC"
 python main.py --dataset $1 --algo_name ncf --rankall --gce --epochs $2 --lr 0.001 --batch_size 2048 --dropout 0.5 --not_early_stopping > results/context/outputs_$1/UIC_graph_$1_NCF_epochs=$2.txt
