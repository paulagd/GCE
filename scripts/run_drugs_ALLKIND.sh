...
#
#python main.py --dataset $1 --algo_name fm --rankall --epochs $2 --lr 0.001 --batch_size 2048 --dropout 0.15 --not_early_stopping --seed 3333 --printall > results/context/outputs_$1/UIC_reindexed_$1_fm_epochs=$2.txt
...
#
#python main.py --dataset $1 --algo_name fm --gce --rankall --epochs $2 --lr 0.01 --batch_size 2048 --dropout 0 --not_early_stopping --seed 3333 --printall > results/context/outputs_$1/UIC_graph_$1_fm_epochs=$2.txt
