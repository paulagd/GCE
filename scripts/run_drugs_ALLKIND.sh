...
#python main.py --dataset $1 --algo_name fm --printall --rankall --reindex --context --epochs $2 --lr 0.0005 --batch_size 512 --dropout 0.5 --not_early_stopping > results/context/outputs_$1/no_context_reindexed_$1_fm_epochs=$2.txt
...
#python main.py --dataset $1 --algo_name mf --gce --rankall --epochs $2 --lr 0.0001 --batch_size 2048 --dropout 0.5 --not_early_stopping > results/context/outputs_$1/UIC_graph_$1_MF_epochs=$2.txt
