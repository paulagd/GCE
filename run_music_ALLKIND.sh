...
#python main.py --dataset $1 --algo_name mf --context --epochs $2 --lr 0.005 --batch_size 256 --dropout 0.5 --not_early_stopping > results/no_context/outputs_$1/reindexed_$1_mf_epochs=$2.txt
#echo "DONE MF REINDEXED" #done
#python main.py --dataset $1 --algo_name fm --context --epochs $2 --lr 0.01 --batch_size 2048 --dropout 0.15 --not_early_stopping > results/no_context/outputs_$1/reindexed_$1_fm_epochs=$2.txt
...
#python main.py --dataset $1 --algo_name mf --save_initial_weights --epochs $2 --lr 0.005 --batch_size 2048 --dropout 0.15 --not_early_stopping > results/context/outputs_$1/UIC_reindexed_$1_mf_epochs=$2.txt
#echo "DONE MF REINDEXED-UIC" #done
#python main.py --dataset $1 --algo_name fm --save_initial_weights --epochs $2 --lr 0.005 --batch_size 2048 --dropout 0.15 --not_early_stopping > results/context/outputs_$1/UIC_reindexed_$1_fm_epochs=$2.txt
#echo "DONE FM REINDEXED-UIC"  #done
python main.py --dataset $1 --algo_name fm --epochs $2 --lr 0.005 --batch_size 1024 --dropout 0.5 --not_early_stopping > results/context/outputs_$1/UIC_reindexed_$1_fm_epochs=$2.txt
echo "DONE FM REINDEXED-UIC"  #done
#
...
#python main.py --dataset $1 --algo_name mf --save_initial_weights --gce --epochs $2 --lr 0.01 --batch_size 1024 --dropout 0.5 --not_early_stopping > results/context/outputs_$1/UIC_graph_$1_mf_epochs=$2.txt
#echo "DONE MF GCE-UIC"  # doing script
#python main.py --dataset $1 --algo_name fm --save_initial_weights --gce --epochs $2 --lr 0.01 --batch_size 1024 --dropout 0.5 --not_early_stopping > results/context/outputs_$1/UIC_graph_$1_fm_epochs=$2.txt
...
echo "Starting GCE-UIC EXPERIMENTS..."
#python main.py --dataset $1 --algo_name mf --epochs $2 --lr 0.01 --batch_size 512 --dropout 0.5 --gce --not_early_stopping --side_information > results/context/outputs_$1/SI_UIC_graph_$1_mf_epochs=$2.txt
#echo "DONE MF-GCE-GENDR SIDE-INFO"   # doing script
#python main.py --dataset $1 --algo_name fm --epochs $2 --lr 0.005 --batch_size 512 --dropout 0.5 --gce --not_early_stopping --side_information > results/context/outputs_$1/SI_UIC_graph_$1_fm_epochs=$2.txt
#echo "DONE FM-GCE-GENDR SIDE-INFO"  # doing script
