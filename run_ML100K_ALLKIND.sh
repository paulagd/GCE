...
python main.py --dataset $1 --rankall --algo_name ncf --epochs $2 --lr 0.0001 --batch_size 1024 --dropout 0.5 --not_early_stopping > results/context/outputs_$1/reindexed_$1_ncf_epochs=$2.txt
...
##echo "DONE FM-GCE"
python main.py --dataset $1 --rankall --algo_name ncf --epochs $2 --lr 0.0001 --batch_size 256 --dropout 0 --gce --not_early_stopping > results/context/outputs_$1/graph_$1_ncf_epochs=$2.txt
echo "DONE NCF-GCE"
...
python main.py --dataset $1 --rankall --algo_name ncf --epochs $2 --lr 0.01 --batch_size 512 --dropout 0.15 --gce --not_early_stopping --side_information > results/context/outputs_$1/SI_UIC_graph_$1_ncf_epochs=$2.txt
echo "DONE NCF-GCE-GENDR SIDE-INFO"   # doing script
