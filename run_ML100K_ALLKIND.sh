...
python main.py --dataset $1 --algo_name fm --save_initial_weights --epochs $2 --lr 0.0005 --batch_size 512 --dropout 0 --not_early_stopping > results/context/outputs_$1/UIC_reindexed_$1_fm_epochs=$2.txt
...
python main.py --dataset $1 --algo_name fm --save_initial_weights --gce --epochs $2 --lr 0.005 --batch_size 512 --dropout 0.5 --not_early_stopping > results/context/outputs_$1/UIC_graph_$1_fm_epochs=$2.txt
...
#python main.py --dataset $1 --algo_name fm --epochs $2 --lr 0.01 --batch_size 2048 --dropout 0 --gce --not_early_stopping --side_information > results/context/outputs_$1/SI_UIC_graph_$1_fm_epochs=$2.txt
#echo "DONE FM-GCE-GENDR SIDE-INFO"  # doing script