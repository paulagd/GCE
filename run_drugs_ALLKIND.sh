...
python main.py --dataset $1 --algo_name mf --rankall --epochs $2 --lr 0.0001 --batch_size 2048 --dropout 0.15 --not_early_stopping > results/context/outputs_$1/UIC_reindexed_$1_MF_epochs=$2.txt
echo "DONE MF REINDEXED-UIC"
#python main.py --dataset $1 --algo_name ncf --rankall --epochs $2 --lr 0.01 --batch_size 1024 --dropout 0.5 --not_early_stopping > results/context/outputs_$1/UIC_reindexed_$1_NCF_epochs=$2.txt
...
#echo "DONE FM GCE-UIC"  DONE
#python main.py --dataset $1 --algo_name mf --gce --rankall --epochs $2 ? --not_early_stopping > results/context/outputs_$1/UIC_graph_$1_MF_epochs=$2.txt
#echo "DONE MF GCE-UIC"
#python main.py --dataset $1 --algo_name ncf --gce --rankall --epochs $2 --lr 0.0001 --batch_size 256 --dropout 0.15  --not_early_stopping > results/context/outputs_$1/UIC_graph_$1_NCF_epochs=$2.txt
...
#python main.py --dataset $1 --algo_name mf --rankall --epochs $2 --lr 0.005 --batch_size 1024 --dropout 0.5 --gce --not_early_stopping --side_information > results/context/outputs_$1/SI_UIC_graph_$1_MF_epochs=$2.txt
#echo "DONE MF-GCE-GENDR SIDE-INFO"
#python main.py --dataset $1 --algo_name ncf --rankall --epochs $2 --lr 0.005 --batch_size 512 --dropout 0.15 --gce --not_early_stopping --side_information > results/context/outputs_$1/SI_UIC_graph_$1_NCF_epochs=$2.txt
