...
#
#python main.py --dataset $1 --algo_name fm --rankall --epochs $2 --lr 0.0001 --batch_size 256 --dropout 0 --not_early_stopping > results/context/outputs_$1/UIC_reindexed_$1_fm_epochs=$2.txt
#echo "DONE FM REINDEXED-UIC"    running
...
#echo "DONE FM GCE-UIC"                          proposal -- 0.15, 0.005, 512

echo "Starting GRAPH EXPERIMENTS WITH ARTIST SIDE effect ON X MATRIX and CONTEXT NODES..."
#
python main.py --dataset $1 --algo_name fm --rankall --epochs $2 --lr 0.0001 --batch_size 1024 --dropout 0.15 --gce --not_early_stopping --side_information > results/context/outputs_$1/SI_UIC_graph_$1_fm_epochs=$2.txt
echo "DONE FM-GCE-GENDR SIDE-INFO"   #running
