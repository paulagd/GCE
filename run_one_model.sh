...
python main.py --dataset $1 --algo_name $3 --epochs $2 > results/context/outputs_$1/reindexed_$1_$3_epochs=$2.txt
echo "DONE $1-$3 REINDEXED"

echo "Starting GRAPH context experiments  on $1..."
python main.py --dataset $1 --algo_name $3 --gce --epochs $2 > results/context/outputs_$1/graph_$1_$3_epochs=$2.txt
echo "DONE $1-$3 REINDEXED-GCE"
