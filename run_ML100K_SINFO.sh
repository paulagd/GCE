...
python main.py --dataset $1 --algo_name mf --epochs $2 --lr 0.0001 --batch_size 256 --dropout 0.5 --gce --not_early_stopping --side_information > results/context/outputs_$1/SI_graph_$1_mf_epochs=$2.txt
